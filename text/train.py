...
def _main():
    ...
    log_dir = 'text/logs/{}'.format(str(date.today()))
    if not osp.exists(log_dir):
        os.makedirs(log_dir)
    classes_path = 'text/classes.txt'
    anchors_path = 'text/anchors.txt'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
                             ...
                             weights_path='text/logs/2019-05-20/048-257.762-256.907.h5'
                             )

    csv_logger = CSVLogger(filename='text/yolo3_icdar2019_art_608_608_training.csv',
                           separator=',',
                           append=True)
    ...
    #     model.save_weights(osp.join(log_dir, 'trained_weights_stage_1.h5'))
    ...
    if True:
        ...
        model.save_weights(osp.join(log_dir, 'trained_weights_final.h5'))
...
def create_model(input_shape, anchors, num_classes,
    ...
    if load_pretrained:
        model_body.load_weights('/home/adam/workspace/github/xuannianz/yolo3/yolo3_weights.h5', by_name=True, skip_mismatch=True)
...
def data_generator(annotation_lines, batch_size, input_shape, anchors, num_classes):
    ...
    while True:
        ...
        for b in range(batch_size):
            ...
            image, box = get_random_data(annotation_lines[i], input_shape, random=False, max_boxes=128)
