...
yolo = YOLO(
    model_path='text/logs/2019-05-21/052-192.617-193.955.h5',
...
image_paths = glob.glob('/home/adam/.keras/datasets/icdar2019/ArT/test_part1_images/*.jpg')
num_classes = 20
...
for image_path in image_paths:
    ...
    scores = scores[0]
    classes = classes[0]
    filtered_boxes = boxes[scores > 0.05]
    filtered_classes = classes[scores > 0.05]
    filtered_scores = scores[scores > 0.05]
